...
- **625 campings** (549 en España, 76 en Portugal) con nombre real, ubicación verificada y descripción, revisados en tres rondas de investigación web dedicadas región por región (ronda 1: 6 agentes en paralelo Norte/Centro/Este/Andalucía/Islas/Portugal, +90 campings; ronda 2: 5 agentes profundizando en cada comunidad peninsular, +84; ronda 3: 6 agentes más apurando cada comunidad para acercarse a los 600 en España, +112). Se eliminaron todas las entradas que no correspondían a ningún negocio real y se corrigieron ubicaciones erróneas (alguna hasta a 100km de donde debía, incluyendo un caso donde el marcador caía en el mar).
