...
- **748 campings** (672 en España, 76 en Portugal) con nombre real, ubicación verificada y descripción, revisados en cuatro rondas de investigación web dedicadas región por región (ronda 1: 6 agentes en paralelo Norte/Centro/Este/Andalucía/Islas/Portugal, +90 campings; ronda 2: 5 agentes profundizando en cada comunidad peninsular, +84; ronda 3: 6 agentes más apurando cada comunidad, +112; ronda 4: 6 agentes cerrando Galicia/Andalucía/C.Valenciana/Cataluña/Aragón-CyL/resto de comunidades, +123, superando el objetivo de 600 en España). Se eliminaron todas las entradas que no correspondían a ningún negocio real y se corrigieron ubicaciones erróneas (alguna hasta a 100km de donde debía, incluyendo un caso donde el marcador caía en el mar).
